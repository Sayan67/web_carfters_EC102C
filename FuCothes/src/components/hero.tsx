...
const Hero = () => {
  return (
    <main className="w-full lg:h-full h-full bg-slate-900/80 rounded-3xl py-6 px-6 md:flex md:fle text-white">

      {/* Hero section */}
      <div className="relative w-full md:flex flex-col justify-end items-center  px-4 lg:px-10 font-questrial">

        {/* Small rounded banners */}
        <div className="absolute top-[7vw] md:top-[7vw] left-[3vw] hidden lg:flex justify-between gap-4 translate-y-[120%] lg:-translate-y-[125%] text-slate-400">
        ...
        {/* Hero section text */}
        <h1 className=" absolute top-[5vw] md:top-[7vw] left-[3vw] font-space_grotesk text-white text-[7vmax] leading-none md:whitespace-nowrap">
          Your Style Speaks.
        </h1>

        {/* Thin border */}
        <div className="hidden w-full top-[7vw] border-b-[1px] pt-60 md:h-fit border-slate-700 md:flex gap-4 lg:p-6 items-center pb-5 md:pt-36 mb-8">
        ...
        <div className="flex flex-col gap-6 justify-between w-full pt-60 md:pt-0">
          <div className="sm:hidden justify-between gap-4 text-slate-400">
            <h1 className="border-[1px] border-slate-700 rounded-full py-2 px-3">Most fresh collection in market</h1>
            <h1 className="flex gap-2 items-center border-[1px] border-slate-700 rounded-full py-[0.18rem]  text-[] px-3"><SiSpring />Spring Collection<SiSpring /></h1>
          </div>
      ...
      <div className="relative w-full flec-col md:flex items-start justify-center ">
        <div className="relative overflow-hidden">
          <div className=" absolute top-[7vw] text-black text-[7vmax] leading-none whitespace-nowrap font-space_grotesk lg:-translate-x-[13.8vw] xl:-translate-x-[80%] hidden md:block">Speaks.</div>
          <Image
