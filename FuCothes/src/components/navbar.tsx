...
const Navbar = () => {
  return (
    <div className="bg-black px-6 py-4 flex justify-between font-rorobot_con tracking-widest items-center text-white font-extralight">

      {/* Logo */}
      <a href="/" className="hover:rotate-180 duration-500">
        <Image src={"/images/ECELogo.png"} alt="logo" width={30} height={50}></Image>
      </a>
      ...
      <div className="flex items-center gap-2 ">
        ...
        {/* cart */}
        <a href="/cart" className="p-[0.18rem] lg:p-[0.3rem] bg-slate-800 rounded-full"><CiShoppingCart size={25} /></a>
            ...
            acc.map((item) => {
              return (
                <a href="/profile">
                  ...
                  <Image src={item.avatar} alt="image" width={40} height={40} className="rounded-full border-[2px] border-slate-500"></Image>
                </a>
              )
            })
          }
